...
with open('linkliste_sample Mindfactory.csv', 'r') as file:
    ...
    output = open(date1 + " Mindfactory_CLC.csv", "w+")
    ...
    driver.get("https://www.compuland-city.de/")
    time.sleep(4)
    ...
    for a in linklist_all:
        try:
            ...
            link_product = str(a).replace("https://www.mindfactory.de/","https://www.compuland-city.de/")
